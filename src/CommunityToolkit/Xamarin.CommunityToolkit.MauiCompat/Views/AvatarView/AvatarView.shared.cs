using System;using Microsoft.Extensions.Logging;using static Microsoft.Maui.Controls.Compatibility.AbsoluteLayout;using Microsoft.Maui.Layouts;using AbsoluteLayout = Microsoft.Maui.Controls.Compatibility.AbsoluteLayout;
using System.IO;
...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	public class AvatarView : BaseTemplatedView<Frame>
	{
		...
		/// </summary>
		public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(AvatarView), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnValuePropertyChanged);

		/// <summary>
		/// Backing BindableProperty for the <see cref="Color"/> property.
		/// </summary>
		public static readonly BindableProperty ColorProperty = BindableProperty.Create(nameof(Color), typeof(Color), typeof(AvatarView), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnValuePropertyChanged);
		...
		/// </summary>
		public static readonly BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(AvatarView), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnValuePropertyChanged);
		...
		{
			IsClippedToBounds = true;
			MainLayout.Children.Add(Label, new Rect(0.5, 0.5, -1, -1), AbsoluteLayoutFlags.PositionProportional);
			MainLayout.Children.Add(Image, new Rect(0, 0, 1, 1), AbsoluteLayoutFlags.All);
		...
		void OnValuePropertyChanged()
		{
			...
			{
				AbsoluteLayout.SetLayoutBounds(Image, new Rect(.5, .5, -1, -1));
			...
			Label.TextColor = textColor == new Microsoft.Maui.Graphics.Color()
			...
			var color = Color;
			MainLayout.BackgroundColor = color == new Microsoft.Maui.Graphics.Color()
