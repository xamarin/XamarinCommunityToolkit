...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	public class BadgeView : BaseTemplatedView<Microsoft.Maui.Controls.Compatibility.Grid>
	{
		...
		public static new BindableProperty BackgroundColorProperty =
			BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(BadgeView), defaultValue: new Microsoft.Maui.Graphics.Color(),
				propertyChanged: OnLayoutPropertyChanged);
		...
		public static readonly BindableProperty BorderColorProperty =
			BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(BadgeView), new Microsoft.Maui.Graphics.Color(),
				propertyChanged: OnLayoutPropertyChanged);
		...
		public static BindableProperty TextColorProperty =
			BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(BadgeView), defaultValue: new Microsoft.Maui.Graphics.Color(),
				propertyChanged: OnLayoutPropertyChanged);
