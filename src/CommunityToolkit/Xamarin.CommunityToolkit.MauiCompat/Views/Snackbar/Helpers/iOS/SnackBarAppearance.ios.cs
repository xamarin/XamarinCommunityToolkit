...
namespace Xamarin.CommunityToolkit.UI.Views.Helpers.iOS
{
	class NativeSnackBarAppearance
	{
		...
		public static UIColor DefaultColor { get; } = XCT.IsiOS13OrNewer ? new Microsoft.Maui.Graphics.Color().ToUIColor() : UIColor.White;
	...
	static class NativeSnackButtonAppearance
	{
		...
		public static UIColor DefaultColor { get; } = new Microsoft.Maui.Graphics.Color().ToUIColor();
