...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	class SnackBar
	{
		...
		{
			var renderer = (await GetRendererWithRetries(sender))?.View ?? sender.ToNative(sender.Handler.MauiContext) ?? throw new ArgumentException("Provided VisualElement cannot be parent to SnackBar", nameof(sender));
