...
namespace Xamarin.CommunityToolkit.UI.Views
{
	public class RangeSlider : BaseTemplatedView<AbsoluteLayout>
	{
		...
		public static BindableProperty ThumbColorProperty
			= BindableProperty.Create(nameof(ThumbColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty LowerThumbColorProperty
			= BindableProperty.Create(nameof(LowerThumbColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty UpperThumbColorProperty
			= BindableProperty.Create(nameof(UpperThumbColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty TrackColorProperty
			= BindableProperty.Create(nameof(TrackColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty TrackHighlightColorProperty
			= BindableProperty.Create(nameof(TrackHighlightColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty ThumbBorderColorProperty
			= BindableProperty.Create(nameof(ThumbBorderColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty LowerThumbBorderColorProperty
			= BindableProperty.Create(nameof(LowerThumbBorderColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty UpperThumbBorderColorProperty
			= BindableProperty.Create(nameof(UpperThumbBorderColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty TrackBorderColorProperty
			= BindableProperty.Create(nameof(TrackBorderColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);

		public static BindableProperty TrackHighlightBorderColorProperty
			= BindableProperty.Create(nameof(TrackHighlightBorderColor), typeof(Color), typeof(RangeSlider), new Microsoft.Maui.Graphics.Color(), propertyChanged: OnLayoutPropertyChanged);
		...
		void OnLayoutPropertyChanged()
		{
			...
			Track.BorderColor = GetColorOrDefault(TrackBorderColor, new Microsoft.Maui.Graphics.Color());
			TrackHighlight.BorderColor = GetColorOrDefault(TrackHighlightBorderColor, new Microsoft.Maui.Graphics.Color());
		...
		Color GetColorOrDefault(Color color, Color defaultColor)
			=> color == new Microsoft.Maui.Graphics.Color()
				? defaultColor
				: color;
