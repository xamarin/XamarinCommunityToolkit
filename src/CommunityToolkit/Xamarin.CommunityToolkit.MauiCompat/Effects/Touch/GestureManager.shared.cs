...
namespace Xamarin.CommunityToolkit.Effects
{
	sealed class GestureManager
	{
		...
		Task SetBackgroundColor(TouchEffect sender, TouchState touchState, HoverState hoverState, int duration, Easing? easing)
		{
			...
			if (sender.Element == null
				|| (normalBackgroundColor == new Microsoft.Maui.Graphics.Color()
					&& pressedBackgroundColor == new Microsoft.Maui.Graphics.Color()
					&& hoveredBackgroundColor == new Microsoft.Maui.Graphics.Color()))
			{
