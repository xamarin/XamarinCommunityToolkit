...
{
	using Xamarin.CommunityToolkit.MauiCompat; public class PlatformTouchEffect : Microsoft.Maui.Controls.Platform.PlatformEffect
	{
		...
		void StartRipple(float x, float y)
		{
			...
			{
				UpdateRipple(Microsoft.Maui.Graphics.Colors.Transparent);
			}
		}
		...
		ColorStateList GetColorStateList(XColor color)
		{
			...
			if (animationColor .Equals(new Microsoft.Maui.Graphics.Color()))
