...
namespace CommunityToolkit.Maui.UI.Views
{
	...
	public class DockLayout : Layout<View>
	{
		...
		/// <summary>
		/// For internal use by the .NET MAUI Community Toolkit. This method gets the <see cref="Dock"/> property on a child element.
		/// </summary>
		...
		/// <summary>
		/// For internal use by the .NET MAUI Community Toolkit. This method sets the <see cref="Dock"/> property on a child element.
		/// </summary>
