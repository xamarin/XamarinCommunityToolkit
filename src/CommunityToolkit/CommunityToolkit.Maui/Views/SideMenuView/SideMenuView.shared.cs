...
using CommunityToolkit.Maui.UI.Views.Internals;
using Xamarin.Forms;
	...
	public class SideMenuView : BaseTemplatedView<AbsoluteLayout>
	{
		...
		public SideMenuView()
		{
			...
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.Android.UI.Views.SideMenuViewRenderer(ToolkitPlatform.Context ?? throw new NullReferenceException());
#elif __IOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.iOS.UI.Views.SideMenuViewRenderer();
#endif
			#endregion
		}
