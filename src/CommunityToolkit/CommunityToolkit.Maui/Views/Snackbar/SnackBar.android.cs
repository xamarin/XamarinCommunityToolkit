...
namespace CommunityToolkit.Maui.UI.Views
{
	class SnackBar
	{
		internal async ValueTask Show(VisualElement sender, SnackBarOptions arguments)
		{
			...
			if (arguments.BackgroundColor != Xamarin.Forms.Color.Default)
			{
			...
			if (arguments.MessageOptions.Foreground != Xamarin.Forms.Color.Default)
			{
			...
			foreach (var action in arguments.Actions)
			{
				...
				if (action.ForegroundColor != Xamarin.Forms.Color.Default)
				{
