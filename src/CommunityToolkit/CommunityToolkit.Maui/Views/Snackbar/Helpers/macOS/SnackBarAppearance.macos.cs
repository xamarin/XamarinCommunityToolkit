...
namespace CommunityToolkit.Maui.UI.Views.Helpers.macOS
{
	class NativeSnackBarAppearance
	{
		...
		public static NSColor DefaultColor { get; } = Xamarin.Forms.Color.Default.ToNSColor();

		public static NSFont DefaultFont { get; } = Xamarin.Forms.Font.Default.ToNSFont();
