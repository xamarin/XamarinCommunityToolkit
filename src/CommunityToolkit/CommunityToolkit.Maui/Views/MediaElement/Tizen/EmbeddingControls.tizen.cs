		...
		public EmbeddingControls()
		{
			...
			PlayIcon = new Grid
			{
				Children =
				{
					...
					{
						Scale = 0.7,
						Data = (ShapesPathGeometry)new Xamarin.Forms.Shapes.PathGeometryConverter().ConvertFromInvariantString("M93.5 52.4019C95.5 53.5566 95.5 56.4434 93.5 57.5981L5 108.694C3 109.848 0.499996 108.405 0.499996 106.096V3.9045C0.499996 1.5951 3 0.151723 5 1.30642L93.5 52.4019Z"),
						Fill = Brush.White,
						Opacity = 0.4,
			...
			PauseIcon = new Grid
			{
				...
				Children =
				{
					...
					{
						Scale = 0.7,
						Data = (ShapesPathGeometry)new Xamarin.Forms.Shapes.PathGeometryConverter().ConvertFromInvariantString("M1 1H36V131H1V1Z"),
						Fill = Brush.White,
						Opacity = 0.4,
						Aspect = Stretch.Uniform,
					...
					{
						Scale = 0.7,
						Data = (ShapesPathGeometry)new Xamarin.Forms.Shapes.PathGeometryConverter().ConvertFromInvariantString("M71 1H106V131H71V1Z"),
						Fill = Brush.White,
						Opacity = 0.4,
						Aspect = Stretch.Uniform,
						HorizontalOptions = LayoutOptions.Start
