	...
	public class MediaElementRenderer : ViewRenderer<MediaElement, LayoutCanvas>, IMediaViewProvider, IVideoOutput
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<MediaElement> e)
		{
			...
			if (Control == null)
			{
				...
				if (Control != null)
				{
					mediaView = new MediaView(Xamarin.Forms.Forms.NativeParent);
		...
		void OnLayoutUpdated(object sender, Xamarin.Forms.Platform.Tizen.Native.LayoutEventArgs e) => OnLayout();
