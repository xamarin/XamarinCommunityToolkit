	...
	public class LifecycleEffect : RoutingEffect
	{
			...
			: base(EffectIds.LifeCycleEffect)
		{
			...
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.Android.Effects.LifeCycleEffectRouter();
#elif __IOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.iOS.Effects.LifeCycleEffectRouter();
#elif UWP
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.UWP.Effects.LifeCycleEffectRouter();
#endif
		}
