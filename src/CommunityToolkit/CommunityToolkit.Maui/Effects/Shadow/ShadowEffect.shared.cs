	...
	public class ShadowEffect : RoutingEffect
	{
			...
			: base(EffectIds.ShadowEffect)
		{
			...
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.Android.Effects.PlatformShadowEffect();
#elif __IOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.iOS.Effects.PlatformShadowEffect();
#elif __MACOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.macOS.Effects.PlatformShadowEffect();
#elif UWP
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.UWP.Effects.PlatformShadowEffect();
#endif
		}
