	...
	public class IconTintColorEffectRouter : PlatformEffect
	{
		...
		protected override void OnElementPropertyChanged(PropertyChangedEventArgs args)
		{
			...
			if (!args.PropertyName.Equals(IconTintColorEffect.TintColorProperty.PropertyName) &&
				!args.PropertyName.Equals(Xamarin.Forms.Image.SourceProperty.PropertyName) &&
				!args.PropertyName.Equals(Xamarin.Forms.ImageButton.SourceProperty.PropertyName))
				return;
		...
		void SetImageViewTintColor(ImageView image, Xamarin.Forms.Color color)
		{
		...
		void SetButtonTintColor(Button button, Xamarin.Forms.Color color)
		{
