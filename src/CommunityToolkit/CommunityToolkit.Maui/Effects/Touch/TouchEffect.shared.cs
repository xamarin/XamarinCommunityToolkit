	...
	public class TouchEffect : RoutingEffect
	{
			...
			: base(EffectIds.TouchEffect)
		{
			...
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.Android.Effects.PlatformTouchEffect();
#elif __IOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.iOS.Effects.PlatformTouchEffect();
#elif __MACOS__
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.macOS.Effects.PlatformTouchEffect();
#elif TIZEN
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.Tizen.Effects.PlatformTouchEffect();
#elif UWP
			if (System.DateTime.Now.Ticks < 0)
				_ = new CommunityToolkit.Maui.UWP.Effects.PlatformTouchEffect();
#endif
			#endregion
		}
