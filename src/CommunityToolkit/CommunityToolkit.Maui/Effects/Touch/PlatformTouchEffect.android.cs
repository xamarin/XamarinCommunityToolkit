...
namespace CommunityToolkit.Maui.Android.Effects
{
	...
	{
		static readonly Xamarin.Forms.Color defaultNativeAnimationColor = Xamarin.Forms.Color.FromRgba(128, 128, 128, 64);
		...
		float startX;
		float startY;
		Xamarin.Forms.Color rippleColor;
		int rippleRadius = -1;
		...
		ColorStateList GetColorStateList()
		{
			...
			if (nativeAnimationColor == Xamarin.Forms.Color.Default)
