...
{
    /// <summary>
	/// Converts the incoming value to a <see cref="string"/> local time represenation in the datetime format provided.
	/// </summary>
    public class UtcDateTimeToLocalStringConverter : ValueConverterExtension, IValueConverter
    {
        ...
        /// <summary>
		/// Gets or sets the datetime format value of the provided datetime or datetimeoffset for the <see cref="UtcDateTimeToLocalStringConverter"/>. This is a bindable property.
		/// </summary>
