...
namespace Xamarin.CommunityToolkit.Helpers
{
    ...
    static class SafeFireAndForgetExtensions
    {
        ...
        static async void HandleSafeFireAndForget<TException>(ValueTask valueTask, bool continueOnCapturedContext, Action<TException> onException)
        ...
        static void HandleException<TException>(in TException exception, in Action<TException> onException)
			where TException : Exception => onException?.Invoke(exception);
	}
}
