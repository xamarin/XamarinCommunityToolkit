...
namespace Xamarin.Toolkit.Droid.Helpers
{
    ...
    public static class UIExtensions
    {
        ...
        public static void SetSpanAll(this ISpannable str, Java.Lang.Object what)
        {
        ...
        public static void SetMarginSpanAll(this ISpannable str, Thickness margin)
        {
        ...
        public static void SetMarginSpan(this ISpannable str, Thickness margin, int start, int end, SpanTypes flags)
        {
